...
export default function NewsListPage() {
    usePageMeta({
        ...
        description:
            "Semua berita Update terbaru, informasi, dan jadwal maintenance server Tales Hero Indonesia.",
    });
    ...
    return (
        <div className="nl-root">
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/Image/Header/IMG-HR-03.png')",
                }}
            >
                <div className="guides-hero__inner">
                    ...
                    <p className="guides-hero__sub">
                        Semua informasi tentang Tales Hero Indonesia akan di
                        beritahukan dan ditampilkan di Halaman ini.
                    </p>
                </div>
            </section>
            ...
            <div className="nl-page">
                <main className="nl-main">
                    ...
                    >
                        ...
                        >
                            Semua
                            <span className="nl-filter-pill__count">
                                {allArticles.length}
                            </span>
                        </button>
                        {(
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="nc-card__body">
                                                <h3 className="nc-card__title">
                                                    {a.title}
                                                </h3>
                                                {a.excerpt && (
                                                    <p className="nc-card__excerpt">
                                                        {a.excerpt}
                                                    </p>
                                                )}
